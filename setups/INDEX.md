...
| [`impeccable-casenote/`](impeccable-casenote/README.md) | active | Claude Code | local | Version-pinned Impeccable detector (provenance-locked, resolved from its platform npm package) plus a 9-rule Casenote denylist checker, sharing one exit-code contract. `brands/alan-personal.md` stays the single source of truth; no upstream fork. |
